...
data class BackupImportPreview(
    ...
    companion object {
        ...
        private fun sectionGroups(fields: Map<String, Any?>): List<String> = buildList {
            addIfPresent(fields, "Appearance", "theme", "icon_shape", "icon_size", "icon_pack", "icon_packs", "icon_overrides", "themed_icons", "icon_shadow", "grayscale_icons", "dynamic_color", "accent_override", "wallpaper_dim", "page_wallpaper_dims", "page_transition", "badge_style", "label_style", "label_size", "label_weight")
