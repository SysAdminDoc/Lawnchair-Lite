...
data class BackupImportPreview(
    ...
    companion object {
        ...
        private val knownFields = setOf(
            ...
            "theme", "icon_shape", "icon_size", "icon_pack", "icon_overrides", "themed_icons", "icon_shadow", "grayscale_icons", "dynamic_color",
            ...
            "favorite_apps", "folder_columns", "double_tap", "swipe_down", "swipe_up_action", "app_gesture_shortcuts",
            "custom_gesture_pattern", "custom_gesture_action", "gesture_app_custom", "assistant_app", "triple_tap",
        ...
        private fun sectionGroups(fields: Map<String, Any?>): List<String> = buildList {
            addIfPresent(fields, "Appearance", "theme", "icon_shape", "icon_size", "icon_pack", "icon_overrides", "themed_icons", "icon_shadow", "grayscale_icons", "dynamic_color", "accent_override", "wallpaper_dim", "page_wallpaper_dims", "page_transition", "badge_style", "label_style", "label_size", "label_weight")
        ...
        private fun invalidEnumFields(fields: Map<String, Any?>): List<String> = buildList {
            ...
            addInvalidEnum(fields, "custom_gesture_action", GestureAction.entries.map { it.name }.toSet())
