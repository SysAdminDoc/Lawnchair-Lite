    ...
    suspend fun exportBackup(options: BackupExportOptions = BackupExportOptions()): String {
        ...
        return JSONObject().apply {
            ...
            put("backup_options", JSONObject().apply {
                put("include_appearance", options.includeAppearance)
                put("include_layout_widgets", options.includeLayout)
                put("include_drawer_search", options.includeDrawerSearch)
                put("include_gestures", options.includeGestures)
                put("include_feature_settings", options.includeFeatureSettings)
                put("include_custom_labels", options.includeCustomLabels)
            ...
            put("included_sections", JSONArray(options.includedLauncherSections() + options.includedPrivateSections()))
            put("omitted_sections", JSONArray(options.omittedLauncherSections()))
            put("omitted_private_sections", JSONArray(options.omittedPrivateSections()))

            if (options.includeAppearance) {
                put("theme", p[THEME] ?: "MIDNIGHT")
                put("icon_shape", p[ICON_SHAPE] ?: "SQUIRCLE")
                put("icon_size", p[ICON_SIZE] ?: "MEDIUM")
            ...
            if (options.includeLayout) {
                put("grid_cols", p[GRID_COLS] ?: 4)
                put("grid_rows", p[GRID_ROWS] ?: 5)
                put("grid_padding_h", p[GRID_PADDING_H] ?: 6)
                put("grid_padding_v", p[GRID_PADDING_V] ?: 0)
                put("home_grid", p[HOME_GRID] ?: "")
                put("dock_grid", p[DOCK_GRID] ?: "")
                put("shortcut_shelf", p[SHORTCUT_SHELF] ?: "")
                put("dock_count", p[DOCK_COUNT] ?: 5)
            ...
            if (options.includeDrawerSearch) {
            ...
            if (options.includeGestures) {
                put("double_tap", p[DOUBLE_TAP_ACTION] ?: "LOCK_SCREEN")
                put("swipe_down", p[SWIPE_DOWN_ACTION] ?: "NOTIFICATION_SHADE")
            ...
            if (options.includeFeatureSettings) {
                put("show_clock", p[SHOW_CLOCK] ?: true)
                ...
                put("show_dock_search", p[SHOW_DOCK_SEARCH] ?: true)
            }
            ...
            if (options.includeCustomLabels) put("custom_labels", p[CUSTOM_LABELS] ?: "")
        }.toString(2)
    }
